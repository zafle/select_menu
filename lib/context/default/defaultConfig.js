...
const defaultConfig = {
  isSet: false,
  // INPUT CONFIG
  // ID prop is used for hidden input that will receive the selected option value
  // (must be === htmlFor label attribute)
  // - also used in differents other components: dropdown, options
  id: '', // is empty string in V2
  //
  // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // V1
  // Default id prop value was nanoid() in v1
  // id: nanoid(),
  // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
  ...
  // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // V2
  // new prop introduced in v2
  // Allows user to reset selection
